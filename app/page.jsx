...
const PROJECTS = [
  {
    title: "Marriage Counselor Gurgaon Website",description:
  ...
  {
    title: "MindSoulBridge Website",description:
  ...
  {
    title: "RENcomm Corporate Website",description:
      "Developed a professional WordPress website for RENcomm, showcasing their business services with mobile responsiveness, modern layout, and on-page SEO best practices for visibility and performance.",image: "/projectimg/rencom.jpg",link: "https://rencomm.net/",tags: ["WordPress", "Corporate Website", "Responsive Design", "SEO"],
  },
  {
    title: "LiveCure24 Healthcare Website",description:
      "Developed a responsive healthcare service platform using Laravel PHP. Integrated appointment booking, dynamic service management, and implemented on-page SEO to boost online visibility.",image: "/projectimg/livecure.jpg",link: "https://www.livecure24.com/",tags: ["Laravel", "PHP", "Healthcare", "Responsive Design", "SEO"],
  },
  {
    title: "CorpPlace Business Solutions Website",description:
      "Designed and developed a corporate solutions platform using Laravel PHP and Tailwind CSS. Delivered a clean, fully responsive UI with SEO optimization and modular architecture.",image: "/projectimg/corpplace.jpg",link: "https://corpplace.com/",tags: ["Laravel", "PHP", "Tailwind CSS", "Corporate", "Responsive Design"],
  },
  {
    title: "Arabius Language Learning Platform",description:
      "Built a responsive Arabic language learning website using WordPress. Integrated live tutoring features, placement tests, and ensured fast loading speeds with an intuitive user experience.",image: "/projectimg/arabius.jpg",link: "https://arabius.com/",tags: ["WordPress", "EdTech", "Live Tutoring", "Responsive Design", "Performance"],
  },
  {
    title: "Pradeep Classes Coaching Website",description:
      "Developed a responsive educational website using Laravel PHP for Pradeep Classes, featuring multi-course management, modern UI, and strong on-page SEO for high performance and visibility.",image: "/projectimg/study.jpg", link: "https://www.pradeepclasses.com/",tags: ["Laravel", "PHP", "Education", "Responsive Design", "SEO", "Performance"],
  },
];
