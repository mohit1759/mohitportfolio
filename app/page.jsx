      ...
      <main className="container px-4 md:px-6">
        ...
        <section id="projects" className="py-3 md:py-6 lg:py-12">
          <div className="container px-4 md:px-6">
            ...
            <ProjectCard title="CorpPlace Business Solutions Website" description="Designed and developed a corporate solutions platform using Laravel PHP and Tailwind CSS. Delivered a clean, fully responsive UI with SEO optimization and modular architecture." image="/projectimg/1.jpg" link="https://corpplace.com/" tags={["Laravel", "PHP", "Tailwind CSS", "Corporate", "Responsive Design",]}/>
            <ProjectCard title="Arabius Language Learning Platform" description="Built a responsive Arabic language learning website using WordPress. Integrated live tutoring features, placement tests, and ensured fast loading speeds with an intuitive user experience." image="/projectimg/6.jpg" link="https://arabius.com/" tags={["WordPress", "EdTech", "Live Tutoring", "Responsive Design", "Performance"]}/>
            </div>
          </div>
        </section>
