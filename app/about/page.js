    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-[300px] sm:w-[400px]">
        ...
        <nav className="flex flex-col space-y-6 mt-10">
          ...
          <Link href="/mohit-resume.pdf"className="inline-block w-full mt-4 px-4 py-2 bg-primary text-white text-center rounded-md hover:bg-primary/90 transition"onClick={handleLinkClick}>Resume</Link>
        </nav>
      </SheetContent>
    </Sheet>
  );
