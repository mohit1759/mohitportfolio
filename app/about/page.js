  ...
  return (
    <div className=" bg-background relative overflow-hidden">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container grid grid-cols-1 md:grid-cols-3 items-center px-6 md:px-12">
          <Link className="p-4 flex items-center space-x-2" href="/">
            <img
              src="/mohit-profile-pic.jpeg"
              alt="Mohit Soni Profile Picture"
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-r from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="container flex flex-col md:flex-row items-center gap-10 md:gap-20">
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-5xl md:text-6xl font-bold text-blue-600 leading-tight">
              Hi, I’m <span className="text-purple-600">Mohit Soni</span>
            </h1>
          ...
          <div className="flex-shrink-0">
            <img
              src="/mohit-profile-pic.jpeg"
              alt="Mohit Soni"
              className="w-52 h-52 md:w-64 md:h-64 rounded-full object-cover shadow-xl border-4 border-blue-200"
            />
          </div>
        </div>
      </section>
      ...
      <section id="education" className="mt-20 relative">
        <h2 className="text-3xl sm:text-4xl font-bold text-blue-600 mb-12 text-center">
          Education
