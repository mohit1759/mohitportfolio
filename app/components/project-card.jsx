...
export default function ProjectCard({ title, description, image, link, tags }) {
  return (
    <Card className="overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-border/40 hover:border-primary/20 flex flex-col" data-aos="fade-up" data-aos-duration="700">
